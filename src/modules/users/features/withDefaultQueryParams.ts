...
import type {UserInputQueryModel, UsersQueryModel} from "@/modules/users/models/usersModels";


export function withDefaultQueryParams(query: UserInputQueryModel): UsersQueryModel {
    return {
